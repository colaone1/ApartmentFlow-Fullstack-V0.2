...
export default function Home() {
  return (
    ...
    className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-6xl mx-auto h-full px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center bg-white/50 rounded-md">
        <h1 className="text-6xl font-bold m-10 ">Welcome to ApartmentsFlow!</h1>
